...
var secdom = document.getElementById("secdom")
...
const hideModal = () => {
    ...
    document.getElementById("maindom").appendChild(secdom)
...
const showModal = () => {
    ...
    detailBtn.focus()
    document.getElementById("secdom").remove()
    // document.getElementById("maindom").tabIndex = -1
    // document.getElementById("secdom").tabIndex = -1
}

let finaldata; // Declare a global variable

async function getJSON() {
    return fetch('./amazon.json')
